...
SOAK_JOB_ID="${SOAK_JOB_ID:-demo2-minio-soak-${SOAK_RUN_ID}}"
SOAK_MANIFEST_STORE_ROOT="${SOAK_MANIFEST_STORE_ROOT:-s3://mx8-manifests/soak-${SOAK_RUN_ID}}"
...
JOB_ID="${SOAK_JOB_ID}" \
MX8_MANIFEST_STORE_ROOT="${SOAK_MANIFEST_STORE_ROOT}" \
