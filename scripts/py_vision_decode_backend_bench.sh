...
#   MX8_VISION_BENCH_IMAGE_HW=24
#   MX8_VISION_BENCH_BATCH_SIZE=64
#   MX8_VISION_BENCH_STEPS=128
#   MX8_VISION_BENCH_WARMUP_STEPS=8
#   MX8_VISION_BENCH_BACKENDS=rust,python
#   MX8_VISION_BENCH_RUST_CODECS=zune,image,turbo
#   MX8_VISION_BENCH_MODES=decode_only,train_step
#   MX8_VISION_BENCH_TORCH_THREADS_LIST=1,4,8
#   MX8_VISION_BENCH_DECODE_THREADS_LIST=1,4,8
...
IMAGE_HW="${MX8_VISION_BENCH_IMAGE_HW:-24}"
...
MX8_VISION_BENCH_BACKENDS="${MX8_VISION_BENCH_BACKENDS:-rust,python}" \
MX8_VISION_BENCH_RUST_CODECS="${MX8_VISION_BENCH_RUST_CODECS:-zune,image}" \
MX8_VISION_BENCH_MODES="${MX8_VISION_BENCH_MODES:-decode_only,train_step}" \
MX8_VISION_BENCH_TORCH_THREADS_LIST="${MX8_VISION_BENCH_TORCH_THREADS_LIST:-1}" \
MX8_VISION_BENCH_DECODE_THREADS_LIST="${MX8_VISION_BENCH_DECODE_THREADS_LIST:-1}" \
